...
def create_server():
    ...
    # Register all tools
    asyncio.run(register_create_entities(mcp))
    asyncio.run(register_create_relations(mcp))
    asyncio.run(register_introspect_schema(mcp))
    asyncio.run(register_search_entities(mcp))
